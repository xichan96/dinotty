...
pub use git::{
    ...
    workspace_git_compare, workspace_git_conflict_resolve, workspace_git_diff,
    workspace_git_discard, workspace_git_fetch, workspace_git_log, workspace_git_merge,
    workspace_git_operation_action, workspace_git_operation_state, workspace_git_pull,
    workspace_git_push, workspace_git_rebase, workspace_git_reset, workspace_git_revert_commit,
    workspace_git_revert_lines, workspace_git_stage, workspace_git_stage_all,
    workspace_git_stage_lines, workspace_git_stash_apply, workspace_git_stash_drop,
    ...
    workspace_git_unified_diff, workspace_git_unstage, workspace_git_unstage_all, GitBranchInfo,
    GitBranchNameBody, GitBranchPublishBody, GitBranchRenameBody, GitBranchSwitchBody,
    GitBranchesResponse, GitChange, GitCommitActionBody, GitCommitBody, GitCommitDiffQuery,
    GitCommitSummary, GitCompareQuery, GitCompareResponse, GitConflictResolveBody, GitDiffResponse,
    GitDiscardBody, GitFileStatus, GitLogQuery, GitLogResponse, GitOperationActionBody,
    GitOperationStateResponse, GitPathsBody, GitRemote, GitResetBody, GitRevertBody, GitSourceBody,
    GitStageBody, GitStashEntry, GitStashReferenceBody, GitStashSaveBody, GitStashesResponse,
    GitStatusResponse, GitTagCreateBody, GitTagDeleteBody, GitTagEntry, GitTagsResponse,
    GitUnifiedDiffQuery,
};
