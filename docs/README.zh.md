...
<p align="center">
  ...
  <a href="https://discord.gg/A8sMJd2q"><img src="https://img.shields.io/badge/Discord-Community-5865F2?logo=discord&logoColor=white" alt="Discord"></a>
</p>

<p align="center">
  中文 | <a href="../README.md">English</a> | <a href="./README.ru.md">Русский</a> | <a href="./README.pt.md">Português</a> | <a href="./README.ko.md">한국어</a> | <a href="./README.es.md">Español</a> | <a href="./README.de.md">Deutsch</a> | <a href="./README.fr.md">Français</a>
</p>
...
<p align="center">
  <img src="public/images/1.png" alt="手机上运行 Claude Code" width="250" />
  <img src="public/images/2.png" alt="完整键盘布局与 htop" width="250" />
  <img src="public/images/3.png" alt="主题设置" width="250" />
</p>
<p align="center">
  <img src="public/images/4.png" alt="快捷键盘自定义" width="250" />
  <img src="public/images/5.png" alt="系统监控" width="250" />
  <img src="public/images/6.png" alt="通知系统" width="250" />
</p>
<p align="center">
  <img src="public/images/7.png" alt="平板横屏桌面级布局" width="500" />
</p>
...
<p align="center">
  <img src="public/images/gif/1-split-broadcast.gif" alt="分屏广播演示" width="600" />
</p>

**命令收藏** — 右键终端文本直接收藏，分组管理，一键执行：

<p align="center">
  <img src="public/images/gif/2-command-bookmark.gif" alt="命令收藏演示" width="600" />
</p>

**SSH 连接与文件浏览器** — 内建 SSH 客户端，远程会话与本地体验一致，SFTP 文件管理全覆盖：

<p align="center">
  <img src="public/images/gif/3-ssh-file-browser.gif" alt="SSH 连接与文件浏览器演示" width="600" />
</p>

**工作区管理与 Mission Control** — 多工作区隔离，Mission Control 概览，快速切换：

<p align="center">
  <img src="public/images/gif/4-workspace-mission-control.gif" alt="工作区管理演示" width="600" />
</p>

**插件系统** — JS 插件热重载，内置 CC Switch、JSON Formatter 等：

<p align="center">
  <img src="public/images/gif/5-plugin.gif" alt="插件系统演示" width="600" />
</p>

**统一布局系统** - 终端、插件、文件浏览器、网页预览皆为 pane，可拖拽分屏、跨 Tab 移动、提取为新 Tab：

<p align="center">
  <img src="public/images/gif/6-layout-sys.gif" alt="统一布局系统演示" width="600" />
</p>
...
- **多服务器管理** — 注册多台 dinotty 服务端，在 Mission Control 中切换
...
完整方案对比见 [方案对比](zh/getting-started/comparison.md)。
...
- [方案对比](zh/getting-started/comparison.md) — 与 ttyd/gotty/Wetty 及其他 AI Coding 远程方案的差异
- [部署指南](zh/getting-started/deployment.md) — systemd、Docker、Windows 原生运行、跨平台构建、配置说明
- [发布指南](zh/getting-started/releasing.md) — 统一版本管理、版本 PR、`dev` 到 `main` 晋升、Tag 与 GitHub Release
- [文件编辑器](zh/features/file-editor.md) — 分屏、多光标编辑、Cursor Group 跨文件同步
- [通知系统](zh/features/notifications.md) — HTTP API、Claude Code 集成、Open API
- [插件系统](zh/plugins/plugins.md) — 安装、清单、API、内置插件
- [插件开发](zh/plugins/plugin-development.md) — 完整的插件开发文档
- [主机剪贴板 API](zh/api/clipboard-api.md) — 移动端主机粘贴使用的敏感认证接口
- [MCP Server](zh/api/mcp-server.md) — 内置 MCP JSON-RPC 服务器，AI 助手直接操作终端会话
- [Token 权限系统](zh/internals/token-system.md) — 基于 Capability 的多 Token 细粒度访问控制
- [Event Bus](zh/internals/event-bus.md) — 全局事件总线，模块间事件分发
- [审计日志与 Webhook](zh/internals/audit-webhook.md) — API 使用追踪与外部通知
- [贡献指南](zh/getting-started/contributing.md) — 分支策略、Commit 规范、代码风格
...
<p align="center">
  <img src="public/images/qq.png" alt="QQ 群" width="200" />
</p>
