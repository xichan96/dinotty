...
pub use git::{
    ...
    workspace_git_stash_apply, workspace_git_stash_drop, workspace_git_stash_pop,
    ...
    GitCompareQuery, GitCompareResponse, GitConflictResolveBody, GitDiffResponse, GitDiscardBody,
    GitFileStatus, GitLogQuery, GitLogResponse, GitPathsBody, GitRemote, GitRevertBody,
