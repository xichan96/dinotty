import type { KeyBinding } from './keybindingCatalog'

// Pure subset of terminal input helpers (no host composable imports), shared
// with the builtin-keyboard plugin bundle build: the lib build inlines this
// file, while useKeybindings-dependent logic stays in terminalInput.ts
// (host-only, out of the bundle).
