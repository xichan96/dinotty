...
pub use git::{
    ...
    workspace_git_push, workspace_git_rebase, workspace_git_remote_add,
    ...
    workspace_git_stash_drop, workspace_git_stash_pop, workspace_git_stash_save,
    ...
    GitPullBody, GitPushBody, GitRemote, GitRemoteAddBody, GitRemoteBranchDeleteBody,
    GitRemoteNameBody, GitRemoteUpdateBody, GitRepositoriesResponse, GitRepositoryEntry,
    GitResetBody, GitRevertBody,
    GitSourceBody, GitStageBody, GitStashEntry, GitStashReferenceBody, GitStashSaveBody,
