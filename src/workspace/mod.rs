...
pub use git::{
    ...
    workspace_git_cherry_pick, workspace_git_commit, workspace_git_commit_diff,
    ...
    workspace_git_discard, workspace_git_fetch, workspace_git_hunk_action, workspace_git_log,
