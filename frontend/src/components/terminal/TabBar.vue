...
// The two `toolbar-item` slot branches narrow `itemId` differently, so the
// inferred slot type would drop 'broadcast'; declare it explicitly instead.
defineSlots<{
  'toolbar-item'?: (props: { itemId: PreviewToolbarId }) => unknown
  more?: () => unknown
}>()
